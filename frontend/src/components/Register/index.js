    ...
    <div className="register-wrapper">
      <div className="register-card shadow">
        ...
        <form onSubmit={handleSubmit}>
          <input type="text" className="form-control mb-3" name="name" placeholder="Name" required onChange={handleChange} />
          ...
          <input type="text" className="form-control mb-3" name="country" placeholder="Country" required onChange={handleChange} />
